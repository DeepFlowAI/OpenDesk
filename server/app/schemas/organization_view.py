"""
Pydantic schemas for organization view management
"""
...
class OrganizationViewBase(BaseModel):
...
class OrganizationViewCreate(OrganizationViewBase):
    pass


class OrganizationViewUpdate(BaseModel):
...
class OrganizationViewResponse(OrganizationViewBase, TimestampSchema):
...
class OrganizationViewListResponse(PaginatedResponse):
    items: list[OrganizationViewResponse]


class OrganizationViewToggleRequest(BaseModel):
    is_enabled: bool


class OrganizationViewSortItem(BaseModel):
    id: int
    sort_order: int


class OrganizationViewSortRequest(BaseModel):
    items: list[OrganizationViewSortItem]
