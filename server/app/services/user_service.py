...
from app.schemas.user import UserCreate, UserUpdate, UserQueryRequest, UserResponse
...
class UserService:
    ...
    async def update_user(
        ...
        update_data: dict = {}
        field_labels: dict[str, str] = dict(USER_SYSTEM_FIELD_LABELS)
        for field in ("name", "email", "phone", "gender", "address", "remark", "web_id", "organization_id"):
