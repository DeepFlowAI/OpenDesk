"""
UserView model — saved view configurations for user/visitor lists
"""
...
class UserView(Base, TimestampMixin):
    ...
    __table_args__ = (
        Index("ix_user_views_tenant", "tenant_id"),
        Index("ix_user_views_tenant_sort", "tenant_id", "sort_order"),
    )
