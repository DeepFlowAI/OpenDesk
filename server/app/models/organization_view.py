"""
OrganizationView model — saved view configurations for organization lists
"""
...
class OrganizationView(Base, TimestampMixin):
    __tablename__ = "organization_views"
    __table_args__ = (
        Index("ix_organization_views_tenant", "tenant_id"),
        Index("ix_organization_views_tenant_sort", "tenant_id", "sort_order"),
    )
