...
export default function EditOrgFieldPage() {
  ...
  const title = t('of.edit.title', locale, { name: fieldDef.name })
  ...
  return (
    <div className="-m-8 flex flex-col">
      ...
      <div className="sticky -top-8 z-20 flex h-14 shrink-0 items-center justify-between border-b border-border bg-white px-6">
        ...
        >
          {updateMutation.isPending ? t('of.saving', locale) : t('of.save', locale)}
        </button>
      </div>
